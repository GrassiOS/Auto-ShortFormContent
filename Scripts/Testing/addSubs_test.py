...
class VideoTranscriber:
    ...
    def create_video(self):
        ...
        output_video_path = os.path.splitext(self.video_path)[0] + "_WITH_SUBS.mp4"
...
def main():
    # Define your input file and model path here
    input_file = "aitaTEST.mp4"  # Specify your input video file
    base = "base"  # Specify your Whisper model path
    
    transcriber = VideoTranscriber(base, input_file)
